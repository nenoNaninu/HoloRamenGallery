...
{
    public class UIDraggble : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        ...
        private void UpdateDragging()
        {
            ...
            if (RotationMode == HandDraggable.RotationModeEnum.OrientTowardUser || RotationMode == HandDraggable.RotationModeEnum.OrientTowardUserAndKeepUpright)
            {
                draggingRotation = Quaternion.LookRotation(HostTransform.position - pivotPosition);
            }
            else if (RotationMode == HandDraggable.RotationModeEnum.LockObjectRotation)
            {
            ...
            Quaternion usrDirection = Quaternion.LookRotation(- Camera.main.transform.position + HostTransform.position);
            Quaternion newRotation = Quaternion.Lerp(HostTransform.rotation, usrDirection, RotationLerpSpeed);
            if (hostRigidbody == null)
            {
            ...
            if (RotationMode == HandDraggable.RotationModeEnum.OrientTowardUserAndKeepUpright)
            {
